  ...
  return (
    <Listbox value={value} onChange={onChange}>
      <div className="clarify-api-select relative text-xs">
        <ListboxButton
          aria-label={label}
          className="clarify-api-select-button flex min-w-28 items-center justify-between gap-2 rounded-lg border border-white/10 bg-zinc-900 px-2.5 py-1.5 font-mono text-xs font-medium text-zinc-100 outline-hidden transition hover:border-white/20 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400/20 data-open:border-emerald-400 data-open:ring-2 data-open:ring-emerald-400/20"
        >
