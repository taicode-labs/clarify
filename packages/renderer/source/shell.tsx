...
export function TopNav(arg0: { config: ClarifyConfig }) {
  const { config } = arg0
...
export function SidebarItem(arg0: { node: NavigationNode; depth?: number }) {
...
export function Sidebar(arg0: { navigation: NavigationNode[] }) {
