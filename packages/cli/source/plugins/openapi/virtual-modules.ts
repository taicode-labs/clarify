...
import type { ContentDiagnostic, OpenAPISpec, PreparedOpenAPIContent } from '../../types.js'
...
export const routeData = ${JSON.stringify({ spec: opts.spec, tagFilter: opts.tagFilter, preparedContent: opts.preparedContent })};
