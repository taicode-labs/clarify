...
import { getContentRouteBasePath, getContentRouteLocale, getContentRoutePath, getContentRouteTitle } from '../../parsers/content/content-document.js'
import { basePathFromRef, localizedRoutePath, normalizePath } from '../../parsers/router/index.js'
...
export function toDevRouteEntry(route: ContentRoute): DevRouteEntry {
  return {
    path: getContentRoutePath(route),
    filePath: route.filePath,
    locale: getContentRouteLocale(route),
    basePath: getContentRouteBasePath(route),
    kind: route.kind,
