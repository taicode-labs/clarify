...
Clarify parses `.md` and `.mdx` with different semantics. Both support frontmatter, GFM, syntax highlighting, Mermaid, heading navigation, and search. The difference is whether the page needs JSX capabilities.
