...
```mdx
<WebFrame src="/showcase/theming-preview" title="主题预览" />
```

渲染效果：

<WebFrame src="/showcase/theming-preview" title="主题预览" height={360} />

### 不显示模拟窗口

```mdx
<WebFrame src="/showcase/components" title="组件预览" showWindow={false} height={320} />
```
