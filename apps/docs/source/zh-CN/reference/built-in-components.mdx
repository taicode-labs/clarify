...
<CardGroup cols={2}>
  ...
  <Card title="快速开始" icon="rocket" href="/getting-started/installation">
    准备环境、安装 CLI 并创建第一个文档站点。
  </Card>
  <Card title="MDX 写作" icon="file-code-2" href="/features/mdx">
    使用 Markdown、JSX 和内置组件编写更丰富的内容。
  </Card>
  <Card title="OpenAPI 文档" icon="braces" href="/features/openapi">
...
```mdx
<Button href="/getting-started/installation" arrow="right">
  开始安装
</Button>
